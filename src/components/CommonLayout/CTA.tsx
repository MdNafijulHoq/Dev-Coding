    ...
    <section className="py-12 sm:py-16 px-4">
      <div className="container mx-auto">
        <div className="flex w-full flex-col lg:flex-row lg:items-center gap-10 lg:gap-16 overflow-hidden rounded-lg md:rounded-xl bg-[#53389E]">
          {/* Left Content */}
          <div className="flex-1 mx-auto space-y-5 p-6 sm:p-8 lg:px-10 text-center lg:text-left">
            <h3 className="text-2xl sm:text-3xl md:text-4xl font-semibold text-white leading-snug">
              Give us a shot
            </h3>
            <p className="text-[#E9D7FE] max-w-xl mx-auto lg:mx-0 text-sm sm:text-base lg:text-lg">
